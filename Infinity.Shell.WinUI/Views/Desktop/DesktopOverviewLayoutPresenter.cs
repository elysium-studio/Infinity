...
public sealed class DesktopOverviewLayoutPresenter(IWindowCollection windowCollection, IShellLayoutCalculator layoutCalculator, IScroller scroller, IWorkspace workspace, DesktopPageLayoutCalculator pageLayoutCalculator, DesktopPageStrip pageStrip, DesktopWindowPreviewCollection previews)
{
    ...
    public void Synchronise(Canvas previewBackgroundCanvas, Canvas previewCanvas, Canvas focusCanvas, double scale, int monitorOriginX, int monitorOriginY, double spacingProgress)
    {
        IReadOnlyList<TrackedWindow> windows = previews.Synchronise(previewBackgroundCanvas, previewCanvas, focusCanvas, windowCollection.AllTrackedWindows, scale);
    ...
    public void Refresh(int monitorOriginX, int monitorOriginY, double spacingProgress, TimeSpan? transitionDuration = null)
    {
    ...
    public void RefreshWindow(nint handle, int monitorOriginX, int monitorOriginY, double spacingProgress)
    {
    ...
    private void UpdateWindow(TrackedWindow trackedWindow, int monitorOriginX, int monitorOriginY, double spacingProgress, TimeSpan? transitionDuration)
    {
        ...
        preview.Update(x + preview.SourceOffsetX, layout.Y + preview.SourceOffsetY, preview.SourceWidth, preview.SourceHeight, effectiveTransition);
    }
}
