...
internal static unsafe class WindowCaptureSwapChainInterop
{
    public static ICompositionSurface CreateSurface(Compositor compositor, CanvasSwapChain swapChain)
    {
        ...
        try
        {
            ...
            delegate* unmanaged[Stdcall]<nint, nint, float, Guid*, nint*, int> getResource = (delegate* unmanaged[Stdcall]<nint, nint, float, Guid*, nint*, int> )wrapperTable[3];
            ...
            delegate* unmanaged[Stdcall]<nint, nint, nint*, int> createSurface = (delegate* unmanaged[Stdcall]<nint, nint, nint*, int> )compositorTable[5];
        ...
        finally
        {
            ...
            {
                Marshal.Release(nativeSwapChain);
            }
