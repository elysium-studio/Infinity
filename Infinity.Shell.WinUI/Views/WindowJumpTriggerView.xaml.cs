    ...
    UserControl
{
    ...
    private const float JumpDeltaX = 98f;
    ...
    private const float KeysReleaseStart = 3700f;
    ...
    private const float ShiftPressEnd = 600f;
    private const float ShiftPressStart = 400f;

    private const float WindowSnapScale = 0.94f;
    private const float WinPressEnd = 400f;
    private const float WinPressStart = 200f;

    public WindowJumpTriggerView()
    {
        InitializeComponent();
        Loaded += HandleLoaded;
    }

    public WindowJumpTriggerViewModel? ViewModel => DataContext as WindowJumpTriggerViewModel;
    ...
    private void AnimateJumpWindow()
    {
        ...
        scaleAnimation.InsertKeyFrame(RightPressEnd / duration, new Vector3(WindowSnapScale, WindowSnapScale, 1f), pressEasing);
        ...
        scaleAnimation.InsertKeyFrame(LeftPressEnd / duration, new Vector3(WindowSnapScale, WindowSnapScale, 1f), pressEasing);
        ...
        translateAnimation.InsertKeyFrame(RightSettleEnd / duration, JumpDeltaX, pressEasing);
        translateAnimation.InsertKeyFrame(LeftPressStart / duration, JumpDeltaX, pressEasing);
        translateAnimation.InsertKeyFrame(LeftPressEnd / duration, JumpDeltaX, pressEasing);
        ...
        titlebarOpacityAnimation.InsertKeyFrame(RightPressStart / duration, 0.55f, pressEasing);
        titlebarOpacityAnimation.InsertKeyFrame(RightPressEnd / duration, 1f, pressEasing);
        titlebarOpacityAnimation.InsertKeyFrame(RightSettleEnd / duration, 1f, pressEasing);
        titlebarOpacityAnimation.InsertKeyFrame((RightSettleEnd + 200f) / duration, 0.55f, releaseEasing);
        titlebarOpacityAnimation.InsertKeyFrame(LeftPressStart / duration, 0.55f, pressEasing);
        titlebarOpacityAnimation.InsertKeyFrame(LeftPressEnd / duration, 1f, pressEasing);
        titlebarOpacityAnimation.InsertKeyFrame(LeftSettleEnd / duration, 1f, pressEasing);
        titlebarOpacityAnimation.InsertKeyFrame((LeftSettleEnd + 200f) / duration, 0.55f, releaseEasing);
