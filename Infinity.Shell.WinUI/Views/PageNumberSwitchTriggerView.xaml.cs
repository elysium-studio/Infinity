    ...
    UserControl
{
    ...
    private const float KeysReleaseStart = 4600f;
    ...
    private const float ViewportDeltaX = 78f;
    ...
    public PageNumberSwitchTriggerView()
    {
        InitializeComponent();
        Loaded += HandleLoaded;
    ...
    public PageNumberSwitchTriggerViewModel? ViewModel => DataContext as PageNumberSwitchTriggerViewModel;
    ...
    private void AnimateViewportFrame()
    {
        ...
        scaleAnimation.InsertKeyFrame(Press1End / duration, new Vector3(ViewportSnapScale, ViewportSnapScale, 1f), pressEasing);
        ...
        scaleAnimation.InsertKeyFrame(Press2End / duration, new Vector3(ViewportSnapScale, ViewportSnapScale, 1f), pressEasing);
        ...
        scaleAnimation.InsertKeyFrame(Press3End / duration, new Vector3(ViewportSnapScale, ViewportSnapScale, 1f), pressEasing);
        ...
        translateAnimation.InsertKeyFrame(Press1SettleEnd / duration, ViewportDeltaX, pressEasing);
        translateAnimation.InsertKeyFrame(Press2Start / duration, ViewportDeltaX, pressEasing);
        translateAnimation.InsertKeyFrame(Press2End / duration, ViewportDeltaX, pressEasing);
        translateAnimation.InsertKeyFrame(Press2SettleEnd / duration, ViewportDeltaX * 2f, pressEasing);
        translateAnimation.InsertKeyFrame(Press3Start / duration, ViewportDeltaX * 2f, pressEasing);
        translateAnimation.InsertKeyFrame(Press3End / duration, ViewportDeltaX * 2f, pressEasing);
