...
public sealed partial class ApplicationCatalog(ILogger<ApplicationCatalog> logger) : IApplicationCatalog, IApplicationLauncher
{
    ...
    public Task<IReadOnlyList<LaunchableApplication>> GetApplicationsAsync(CancellationToken cancellationToken = default)
    {
        ...
        return cancellationToken.CanBeCanceled ? applications.WaitAsync(cancellationToken) : applications;
    }
    ...
    public Task<ApplicationIcon?> GetIconAsync(LaunchableApplication application, CancellationToken cancellationToken = default)
    {
        ...
        return cancellationToken.CanBeCanceled ? icon.WaitAsync(cancellationToken) : icon;
    }
