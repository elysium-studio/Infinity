...
public partial class DesktopOverlay : ContentControl, IDisposable
{
    public static readonly DependencyProperty HeaderProperty = DependencyProperty.Register(nameof(Header), typeof(object), typeof(DesktopOverlay), new PropertyMetadata(null, OnHeaderPropertyChanged));
    public static readonly DependencyProperty HeaderPlacementProperty = DependencyProperty.Register(nameof(HeaderPlacement), typeof(DesktopOverlayHeaderPlacement), typeof(DesktopOverlay), new PropertyMetadata(DesktopOverlayHeaderPlacement.Top, OnHeaderPlacementPropertyChanged));
    public static readonly DependencyProperty IsBlurEnabledProperty = DependencyProperty.Register(nameof(IsBlurEnabled), typeof(bool), typeof(DesktopOverlay), new PropertyMetadata(true, OnIsBlurEnabledPropertyChanged));
    public static readonly DependencyProperty IsOpenProperty = DependencyProperty.Register(nameof(IsOpen), typeof(bool), typeof(DesktopOverlay), new PropertyMetadata(false, OnIsOpenPropertyChanged));
    public static readonly DependencyProperty IsInputEnabledProperty = DependencyProperty.Register(nameof(IsInputEnabled), typeof(bool), typeof(DesktopOverlay), new PropertyMetadata(false, OnIsInputEnabledPropertyChanged));
    public static readonly DependencyProperty IsMonitorSpanningEnabledProperty = DependencyProperty.Register(nameof(IsMonitorSpanningEnabled), typeof(bool), typeof(DesktopOverlay), new PropertyMetadata(false, OnIsMonitorSpanningEnabledPropertyChanged));
    public static readonly DependencyProperty StaysOpenProperty = DependencyProperty.Register(nameof(StaysOpen), typeof(bool), typeof(DesktopOverlay), new PropertyMetadata(false, OnStaysOpenPropertyChanged));
    ...
    public DesktopOverlayHeaderPlacement HeaderPlacement { get => (DesktopOverlayHeaderPlacement)GetValue(HeaderPlacementProperty); set => SetValue(HeaderPlacementProperty, value); }

    public bool IsBlurEnabled { get => (bool)GetValue(IsBlurEnabledProperty); set => SetValue(IsBlurEnabledProperty, value); }
    ...
    public bool IsMonitorSpanningEnabled { get => (bool)GetValue(IsMonitorSpanningEnabledProperty); set => SetValue(IsMonitorSpanningEnabledProperty, value); }
    ...
    private void OnHeaderPropertyChanged(object? content) => header.SetContent(content);

    private void OnIsBlurEnabledPropertyChanged(bool isBlurEnabled) => host.SetBlurEnabled(isBlurEnabled);
