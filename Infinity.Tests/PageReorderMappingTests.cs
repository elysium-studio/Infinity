...
public sealed class PageReorderMappingTests
{
    ...
    [InlineData(3, 1, 3, 2)]
    [InlineData(4, 1, 3, 4)]
    public void MovingPageRightClosesGap(int page, int sourcePage, int targetPage, int expectedPage)
    {
        Assert.Equal(expectedPage, PageReorderMapping.Map(page, sourcePage, targetPage));
    }
    ...
    [InlineData(2, 3, 1, 3)]
    [InlineData(0, 3, 1, 0)]
    public void MovingPageLeftOpensGap(int page, int sourcePage, int targetPage, int expectedPage)
    {
        Assert.Equal(expectedPage, PageReorderMapping.Map(page, sourcePage, targetPage));
    }
