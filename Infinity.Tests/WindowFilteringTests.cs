...
public sealed class WindowTitleFilterTests
{
    ...
    {
        Assert.True(WindowTitleFilter.Matches("Any window", filterValue));
    }
    ...
    {
        Assert.True(WindowTitleFilter.Matches(title, filterValue));
    }
    ...
    {
        Assert.False(WindowTitleFilter.Matches(title, filterValue));
    }
}
