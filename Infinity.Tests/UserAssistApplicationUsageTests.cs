...
public sealed class UserAssistApplicationUsageTests
{
    ...
    public void ParserDecodesIdentifierAndUsageMetadata()
    {
        ...
        UserAssistApplicationUsageEntry? entry = UserAssistEntryParser.Parse(
    ...
    public void MatcherReturnsMostRecentlyUsedStartApplications()
    {
        LaunchableApplication calculator = new(
            ...
            "Calculator");
        LaunchableApplication paint = new(
            @"shell:AppsFolder\Microsoft.Paint_8wekyb3d8bbwe!App",
            "Paint");
        LaunchableApplication unused = new(@"shell:AppsFolder\Unused.App", "Unused");

        IReadOnlyList<LaunchableApplication> result = UserAssistApplicationMatcher.Match(
            [calculator, paint, unused],
            [
                new UserAssistApplicationUsageEntry(
