...
public sealed class DesktopPageArrangementCoordinatorTests
{
    ...
    public void ArrangePreservesOccupiedSlotsAndFillsEmptySlots()
    {
        ...
        DesktopWindowPlacementCoordinator placementCoordinator = new(store, scroller, workspace, new TestWindowResizeSynchronizer(), new TestWindowCloser(), new TestWindowStateController(), new TestWindowPageTransitionGuard(), placementResolver, occupancyResolver);
