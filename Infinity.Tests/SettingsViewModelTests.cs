...
public sealed class SettingsViewModelTests
{
    ...
    public void DesktopSectionOwnsInjectedItems()
    {
        ...
        Assert.Collection(viewModel, item => Assert.Same(first, item), item => Assert.Same(second, item));
    }


    private sealed class TestSettingViewModel : List<object>, ISettingViewModel
    {
