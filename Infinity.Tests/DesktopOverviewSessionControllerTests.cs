...
public sealed class DesktopOverviewSessionControllerTests
{
    ...
    private sealed class SessionFixture
    {
        ...
        {
            Controller = new DesktopOverviewSessionController(
                new TestDispatcher(),
                Pointer,
                ModifierKeyState,
                ...
                Scroller,
                PresentationSession,
                new TestWindowPreviewSurface(),
                new TestWindowNavigationCoordinator(),
                GlanceBridge,
                SettingsNavigator);
        }
    ...
    private sealed class TestPointerInputSource : IPointerInputSource
    {
        ...
        event Action<int, int>? IPointerInputSource.CursorMoved { add { } remove { } }
        event Action? IPointerInputSource.LeftButtonClicked { add { } remove { } }
        event Action? IPointerInputSource.MiddleButtonClicked { add { } remove { } }
        event Action? IPointerInputSource.RightButtonClicked { add { } remove { } }
        event Action<double>? IPointerInputSource.ScrollVelocityIdle { add { } remove { } }
    ...
    {
        event Action<bool>? IModifierKeyState.StateChanged { add { } remove { } }
    ...
    {
        event Action? IPageGestureSource.SessionStarted { add { } remove { } }
        event Action? IPageGestureSource.SessionEnded { add { } remove { } }
    ...
    {
        event EventHandler<NavigationStartedEventArgs>? IWindowNavigationCoordinator.NavigationStarted { add { } remove { } }
        event EventHandler? IWindowNavigationCoordinator.NavigationCompleted { add { } remove { } }
        event EventHandler? IWindowNavigationCoordinator.WindowActivationRequested { add { } remove { } }
    ...
    private sealed class TestGlanceBridge : IInfinityGlanceBridge
    {
        ...
        event EventHandler<InfinityGlanceAvailabilityChangedEventArgs>? IInfinityGlanceBridge.AvailabilityChanged { add { } remove { } }
        event EventHandler<InfinityGlanceMessageReceivedEventArgs>? IInfinityGlanceBridge.MessageReceived { add { } remove { } }
